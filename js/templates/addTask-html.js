function HTMLTemplateAddTaskEditSubtasks(i, subtask) {
    return /*html*/`<div id="addTaskSubtaskParent${i}" onmouseout="hideImgSubtasksDeleteAndEdit(${i})" onmouseover="showImgSubtasksDeleteAndEdit(${i})" class="cursorPointer height17 hoverGrey padBot5 borderRadius10 padTop5 dFlex alignCenter justBetween">
            ...
            <div id="editTaskSubtask${i}" class="dFlex directionRow padRight10 d-none">
                ...
                <img onclick="deleteEditTaskSubtask(${i})" class="height17 marLeft3" src="./img/delete.png" alt="delete">
            </div>
        </div>
    `;
}
